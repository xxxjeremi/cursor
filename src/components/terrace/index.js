...
const TerraceComponent = () => {
  ...
  useEffect(() => {
    ...
    function loadTour() {
      ...
      settings.set(
        ...
        "/terrace/script.js?v=1743574916908"
      );
      settings.set(
        window.TDV.PlayerSettings.WEBVR_POLYFILL_URL,
        "/terrace/lib/WebVRPolyfill.js?v=1743574916908"
      );
      settings.set(
        window.TDV.PlayerSettings.HLS_URL,
        "/terrace/lib/Hls.js?v=1743574916908"
      );
      settings.set(
  ...
  return (
    <>
      ...
      <Script
        src="/terrace/lib/tdvplayer.js?v=1743574916908"
...
export default TerraceComponent;
