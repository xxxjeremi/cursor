...
const CoffeeShopComponent = () => {
  ...
  useEffect(() => {
    ...
    function loadTour() {
      ...
      settings.set(
        ...
        "/coffee_shop/script.js?v=1743695822812"
      );
      settings.set(
        window.TDV.PlayerSettings.WEBVR_POLYFILL_URL,
        "/coffee_shop/lib/WebVRPolyfill.js?v=1743695822812"
      );
      settings.set(
        window.TDV.PlayerSettings.HLS_URL,
        "/coffee_shop/lib/Hls.js?v=1743695822812"
      );
      settings.set(
  ...
  return (
    <>
      ...
      <Script
        src="/coffee_shop/lib/tdvplayer.js?v=1743695822812"
