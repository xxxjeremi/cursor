...
const ApartmentOneComponent = () => {
  ...
  useEffect(() => {
    ...
    function loadTour() {
      ...
      settings.set(
        ...
        "/apartment1/script.js?v=1743582223752"
      );
      settings.set(
        window.TDV.PlayerSettings.WEBVR_POLYFILL_URL,
        "/apartment1/lib/WebVRPolyfill.js?v=1743582223752"
      );
      settings.set(
        window.TDV.PlayerSettings.HLS_URL,
        "/apartment1/lib/Hls.js?v=1743582223752"
      );
      settings.set(
  ...
  return (
    <>
      ...
      <Script
        src="/apartment1/lib/tdvplayer.js?v=1743582223752"
...
export default ApartmentOneComponent;
