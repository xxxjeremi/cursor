...
const ApartmentTwoComponent = () => {
  ...
  useEffect(() => {
    ...
    function loadTour() {
      ...
      settings.set(
        ...
        "/apartment2/script.js?v=1743587718932"
      );
      settings.set(
        window.TDV.PlayerSettings.WEBVR_POLYFILL_URL,
        "/apartment2/lib/WebVRPolyfill.js?v=1743587718932"
      );
      settings.set(
        window.TDV.PlayerSettings.HLS_URL,
        "/apartment2/lib/Hls.js?v=1743587718932"
      );
      settings.set(
  ...
  return (
    <>
      ...
      <Script
        src="/apartment2/lib/tdvplayer.js?v=1743587718932"
...
export default ApartmentTwoComponent;
