...
const OfficeOneComponent = () => {
  ...
  useEffect(() => {
    ...
    function loadTour() {
      ...
      settings.set(
        ...
        "/office1/script.js?v=1743591263553"
      );
      settings.set(
        window.TDV.PlayerSettings.WEBVR_POLYFILL_URL,
        "/office1/lib/WebVRPolyfill.js?v=1743591263553"
      );
      settings.set(
        window.TDV.PlayerSettings.HLS_URL,
        "/office1/lib/Hls.js?v=1743591263553"
      );
      settings.set(
  ...
  return (
    <>
      ...
      <Script
        src="/office1/lib/tdvplayer.js?v=1743591263553"
...
export default OfficeOneComponent;
