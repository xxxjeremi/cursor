...
const RestaurantComponent = () => {
  ...
  useEffect(() => {
    ...
    function loadTour() {
      ...
      settings.set(
        ...
        "/restaurant/script.js?v=1743683483968"
      );
      settings.set(
        window.TDV.PlayerSettings.WEBVR_POLYFILL_URL,
        "/restaurant/lib/WebVRPolyfill.js?v=1743683483968"
      );
      settings.set(
        window.TDV.PlayerSettings.HLS_URL,
        "/restaurant/lib/Hls.js?v=1743683483968"
      );
      settings.set(
  ...
  return (
    <>
      ...
      <Script
        src="/restaurant/lib/tdvplayer.js?v=1743683483968"
