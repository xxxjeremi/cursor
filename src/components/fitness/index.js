...
const FitnessComponent = () => {
  ...
  useEffect(() => {
    ...
    function loadTour() {
      ...
      settings.set(
        ...
        "/fitness/script.js?v=1743739863709"
      );
      settings.set(
        window.TDV.PlayerSettings.WEBVR_POLYFILL_URL,
        "/fitness/lib/WebVRPolyfill.js?v=1743739863709"
      );
      settings.set(
        window.TDV.PlayerSettings.HLS_URL,
        "/fitness/lib/Hls.js?v=1743739863709"
      );
      settings.set(
  ...
  return (
    <>
      ...
      <Script
        src="/fitness/lib/tdvplayer.js?v=1743739863709"
