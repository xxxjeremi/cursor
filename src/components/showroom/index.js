...
const ShowroomComponent = () => {
  ...
  useEffect(() => {
    ...
    function loadTour() {
      ...
      settings.set(
        ...
        "/showroom/script.js?v=1743694505538"
      );
      settings.set(
        window.TDV.PlayerSettings.WEBVR_POLYFILL_URL,
        "/showroom/lib/WebVRPolyfill.js?v=1743694505538"
      );
      settings.set(
        window.TDV.PlayerSettings.HLS_URL,
        "/showroom/lib/Hls.js?v=1743694505538"
      );
      settings.set(
  ...
  return (
    <>
      ...
      <Script
        src="/showroom/lib/tdvplayer.js?v=1743694505538"
